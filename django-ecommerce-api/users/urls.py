...
urlpatterns = [
    ...
    path("login/google/", GoogleIdTokenLoginAPIView.as_view(), name="user_login_google"),
    ...
    path("create-jwt/", CreateJWTTokenAPIView.as_view(), name="create_jwt_token"),
